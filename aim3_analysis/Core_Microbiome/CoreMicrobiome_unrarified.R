...
tub_venn_nonrare <- ggVennDiagram(x = Tub_list_full)
tub_venn_nonrare
ggsave("tub_venn_nonrare.png", tub_venn_nonrare)
...
phylo_primates_captive_ASVs <-core_members(phylo_primates_captive, detection=0, prevalence = 0.5)
phylo_primates_wild_ASVs <-core_members(phylo_primates_wild, detection=0, prevalence = 0.5)
...
primates_venn_nonrare <- ggVennDiagram(x = primates_list_full)
primates_venn_nonrare
ggsave("primates_venn_nonrare.png", primates_venn_nonrare)
...
pilosa_venn_nonrare <- ggVennDiagram(x = pilosa_list_full)
pilosa_venn_nonrare
ggsave("pilosa_venn_nonrare.png", pilosa_venn_nonrare)
...
prune_taxa(phylo_per_captive_ASVs,phyloseq_file) %>%
  tax_table()

prune_taxa(phylo_per_wild_ASVs,phyloseq_file) %>%
  tax_table()

tax_table(prune_taxa(phylo_per_captive_ASVs,phyloseq_file))
tax_table(prune_taxa(phylo_per_wild_ASVs,phyloseq_file))

pruned_data_per_captive <- prune_taxa(phylo_per_captive_ASVs, phyloseq_file) %>%
  plot_bar(fill = "Genus") +
  facet_wrap(~ captive_wild, scales = "free")

pruned_data_per_wild <- prune_taxa(phylo_per_wild_ASVs,phyloseq_file) %>%
  plot_bar(fill = "Genus") +
  facet_wrap(~ captive_wild, scales = "free")
...
per_venn_nonrare <- ggVennDiagram(x = per_list_full)
per_venn_nonrare
ggsave("per_venn_nonrare.png", per_venn_nonrare)
...
prune_taxa(phylo_cet_captive_ASVs,phyloseq_file) %>%
  tax_table()

prune_taxa(phylo_cet_wild_ASVs,phyloseq_file) %>%
  tax_table()

tax_table(prune_taxa(phylo_cet_captive_ASVs,phyloseq_file))
tax_table(prune_taxa(phylo_cet_wild_ASVs,phyloseq_file))

pruned_data_cet_captive <- prune_taxa(phylo_cet_captive_ASVs, phyloseq_file) %>%
  plot_bar(fill = "Genus") +
  facet_wrap(~ captive_wild, scales = "free")

pruned_data_cet_wild <- prune_taxa(phylo_cet_wild_ASVs,phyloseq_file) %>%
  plot_bar(fill = "Genus") +
  facet_wrap(~ captive_wild, scales = "free")
...
cet_venn_nonrare <- ggVennDiagram(x = cet_list_full)
cet_venn_nonrare
ggsave("cet_venn_nonrare.png", cet_venn_nonrare)
...
prune_taxa(phylo_carn_captive_ASVs,phyloseq_file) %>%
  tax_table()

prune_taxa(phylo_carn_wild_ASVs,phyloseq_file) %>%
  tax_table()

tax_table(prune_taxa(phylo_carn_captive_ASVs,phyloseq_file))
tax_table(prune_taxa(phylo_carn_wild_ASVs,phyloseq_file))

pruned_data_carn_captive <- prune_taxa(phylo_carn_captive_ASVs, phyloseq_file) %>%
  plot_bar(fill = "Genus") +
  facet_wrap(~ captive_wild, scales = "free")

pruned_data_carn_wild <- prune_taxa(phylo_carn_wild_ASVs,phyloseq_file) %>%
  plot_bar(fill = "Genus") +
  facet_wrap(~ captive_wild, scales = "free")
...
carn_venn_nonrare <- ggVennDiagram(x = carn_list_full)
carn_venn_nonrare
ggsave("carn_venn_nonrare.png", carn_venn_nonrare)
