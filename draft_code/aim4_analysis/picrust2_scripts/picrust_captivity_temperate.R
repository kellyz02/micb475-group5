...
metadata_temperate <- metadata %>% filter(Climate_basic == "C")
...
#this line will change for each dataset. 118 represents the number of samples in the filtered abundance table
abundance_desc = abundance_desc[,-c(118:ncol(abundance_desc))] 
...
ggsave("captivity_temperate_log2foldchange.png"
       , log2foldchange
       , height=6, width=12)
